# AGENTS.md Instructions for Portfolio Development

These instructions apply to all Astro portfolio work. Prioritize clean, reusable, accessible, fast, SEO-friendly code. Treat the site as a maintainable personal portfolio, not as a one-off implementation.

## General Principles

* Prefer simple, maintainable Astro components over unnecessary abstractions.
* Keep Astro's advantage: mostly static HTML, minimal JavaScript, and hydration only where needed.
